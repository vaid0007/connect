...
<body class="battery-car-service">
	...
	<div class="services-detail">
		...
		<div class="services-first">
			<h2 class="special-heading">TELECOM DESIGN CONSULTANCY</h2>
			<p>Complete design solutions covering system architecture, drawings, interface engineering, and documentation for telecom subsystems in metro rail projects.</p>
		</div>
